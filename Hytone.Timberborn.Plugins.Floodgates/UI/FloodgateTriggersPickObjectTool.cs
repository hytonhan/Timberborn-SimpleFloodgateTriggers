...
namespace Hytone.Timberborn.Plugins.Floodgates.UI
{
	...
	private readonly ISpecService _specService;
        ...
        private void HighlightCandidates()
        {
            ...
            {
                // var color = _validateCandidate(allCandidate.Key) == "" ? _colors.BuildablePreview : _colors.UnbuildablePreview; 
                var color = _validateCandidate(allCandidate.Key) == "" ? Color.yellow : Color.red; 
                _highlighter.HighlightSecondary(allCandidate.Value, color);
            }
        }
