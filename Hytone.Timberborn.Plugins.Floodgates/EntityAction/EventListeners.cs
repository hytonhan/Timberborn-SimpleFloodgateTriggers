...
namespace Hytone.Timberborn.Plugins.Floodgates.EntityAction
{
    public class EventListeners : ILoadableSingleton
    {
        ...
        public void OnHazardousWeatherStarted(HazardousWeatherStartedEvent hazardousWeatherStartedEvent)
        {
            ...
            // var foo = GameObject.FindFirstObjectByType<FloodgateTriggerMonoBehaviour>();
            // var floodgates = GameObject.FindObjectsByType<FloodgateTriggerMonoBehaviour>(FindObjectsSortMode.None);
            // if (floodgates != null)
            // {
